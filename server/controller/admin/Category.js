...
// getting selected category page for editing 
...
// this is for updating category controller
...
//     const products = await Product.find({selectedCategory : categoryName})
...
const editedCategory = async (req, res) => {
  try {
    ...
    const updatePromises = products.map(async (product) => {
      ...
      const effectiveDiscount = Math.max(productDiscount, discount);

      const newSalesPrice = regularPrice - effectiveDiscount;
